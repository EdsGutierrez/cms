...
class ConfiguracionController extends Controller
{
    ...
    {
        return view('admin.configuracion.configuracion');
    }
    ...
    public function postHome(Request $request)
    {
        ...
        $file = fopen(config_path() . '/cms.php', 'w'); //abrir el archivo
        fwrite($file, '<?php' . PHP_EOL);      //Escribir en el archivo línea por línea con PHP_EOL
