            ...
            <div class="items mtop32">
                <div class="row">
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="header">
                                <h2 class="title"><i class="fa-solid fa-circle-info"></i> Detalles de la orden <strong>N°
                                        {{ $order->o_number }}</strong></h2>
                            </div>
                            <div class="inside">
                        ...
                        <div class="panel mtop16">
                            ...
                            <div class="inside">
                                <div class="payments_methods">
                                    <a href="#" class="w-100 active" id="payment_method_cash"
