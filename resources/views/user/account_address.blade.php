    ...
    <div class="col-md-3">
        <div class="panel shadow">
            ...
            <div class="inside">
                ...
                <label for="add3" class="mtop16">Casa / Apartamento N° </label>
                <div class="input-group">
                    <span class="input-group-text" id="basic-addon1">
                        <i class="far fa-keyboard"></i>
                    </span>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>
                                    <a href="{{ url('/account/address/'.$address->id.'/setdefault') }}"> Convertir en
                                        dirección principal</a>
                                </p>
                                @else
                            ...
                            <td>
                                <p>
                                    <strong>Barrio, colonia o residencial: </strong>
                                    {{ kvfj($address->addr_info, 'add1') }}
                                </p>
                                <p>
                                    <strong>Calle / Avenida / Bloque: </strong>
                                    {{ kvfj($address->addr_info, 'add2') }}
                                </p>
                                <p>
                                    <strong>Casa / Apartamento N°l: </strong>
