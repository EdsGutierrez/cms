                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form_quantity">
                                                            ...
                                                            <button type="submit"><i class="far fa-save"
                                    ...
                                    @if ($order->o_type == '0')
                                        @if (!is_null(Auth::user()->getAddressDefault))
                                            <p style="margin-bottom: 2px;"><strong>Estado:
                                                </strong>{{ Auth::user()->getAddressDefault->getState->name }}</p>
                                            <p style="margin-bottom: 2px;"><strong>Ciudad:
                                                </strong>{{ Auth::user()->getAddressDefault->getCity->name }}</p>
                                            ...
                                            <p style="margin-bottom: 2px;"><strong>Referencia:
                                                </strong>{{ kvfj(Auth::user()->getAddressDefault->addr_info, 'add4') }}</p>
                                    ...
                                    @if (config('cms.to_go') == '1')
                                        <div class="edswitch">
                                            <a href="{{ url('/cart/' . $order->id . '/type/0') }}"
                                                class="sl @if ($order->o_type == ' 0') active @endif">
                                                <i class="fas fa-motorcycle"></i> Domicilio
                                            </a>

                                            <a href="{{ url('/cart/' . $order->id . '/type/1') }}"
                                                class="sl @if ($order->o_type == ' 1') active @endif">
                                ...
                                <div class="inside">
                                    <div class="payments_methods">
                                        ...
                                        @if (config('cms.payment_method_credit_card') == '1')
                                            <a href="#" class="btn-payment-method w-100"
                                                id="payment_method_credit_card" data-payment-method-id="3">
