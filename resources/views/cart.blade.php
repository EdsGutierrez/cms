        ...
        <div class="no_items shadow">
            <div class="inside">
                ...
                <p>
                    ...
                    , Aún no tienes nada en tu carrito de compras,
                    anímate a agregar uno de nuestros increibles productos
                </p>
                            ...
                            <table class="table table-striped align-middle table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                ...
                                                <div class="price_discount">
                                                    ...
                                                    <span class="price_initial">{{ config('cms.currency') . ' ' .
                                                        number_format($item->price_initial, 2, '.', ',') }}
                                                    </span> /
                                                    @endif
                                                    <span class="price_unita">{{ config('cms.currency') . ' ' .
                                        ...
                                        <td>
                                            ...
                                            <div class="form_quantity">
                                                ...
                                                {!! Form::number('quantity', $item->quantity, ['min' => '1', 'class' =>
                                                'form-control']) !!}
                                                <button type="submit"><i class="far fa-save" data-toggle="tooltip"
                                                        data-placement="top" title="Actualizar"></i></button>
                                                {!! Form::close() !!}
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>{{ number($shipping) }}</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"></td>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel">
                        ...
                        <div class="inside">
                            ...
                            <p style="margin-bottom: 2px;"><strong>Estado: </strong>{{
                            ...
                            <p style="margin-bottom: 2px;"><strong>Dirección: </strong>{{
                                ...
                                {{ kvfj(Auth::user()->getAddressDefault->addr_info, 'add3') }}.</p>

                            <p style="margin-bottom: 2px;"><strong>Referencia: </strong>{{
                                kvfj(Auth::user()->getAddressDefault->addr_info, 'add4') }}</p>
                            <a href="{{ url('/account/address') }}" class="btn btn-dark mtop16">Cambiar dirección</a>
                            @else
                            <p>Su usuario no tiene direcciones registradas</p>
                            <p><a href="{{ url('/account/address') }}" class="btn btn-dark mtop16">Agregar dirección</a>
                            </p>
                            @endif
                            @endif
                            @if(config('cms.to_go') == "1")
                            <div class="edswitch">
                                <a href="{{ url('/cart/'.$order->id.'/type/0') }}" class="sl @if($order->o_type == " 0")
                                    active @endif">
                                    <i class="fas fa-motorcycle"></i> Domicilio
                                </a>

                                <a href="{{ url('/cart/'.$order->id.'/type/1') }}" class="sl @if($order->o_type == " 1")
                                    active @endif">
                    ...
                    <div class="panel mtop16">
                        ...
                        <div class="inside">
                            <div class="payments_methods">
                                ...
                                <a href="#" class="btn-payment-method w-100" id="payment_method_cash"
                    ...
                    <div class="panel mtop16">
                        <div class="inside">
                            {!! Form::submit('Completar orden', ['class' => 'btn btn-success disabled', 'id' =>
                            'pay_btn_complete']) !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
