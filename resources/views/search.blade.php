    ...
    <div class="store">
        <div class="row">
            ...
            <div class="col-md-9 mtop32">
                ...
                <div class="store_white shadow-lg mtop32">
                    <section>
                            ...
                            @foreach ($products as $product)
                                <div class="product">
                                    ...
                                    <a href="{{ url('/product/' . $product->id . '/' . $product->slug) }}">
                                        ...
                                        <div class="price">{{ Config::get('mycms.currency') }} {{ $product->price }}</div>
                                    </a>
