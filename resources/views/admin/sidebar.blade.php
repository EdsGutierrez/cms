        ...
        <ul>
            ...
            <li>
                <a href="{{ url('/admin/categories/0') }}"
                    class="lk-categories lk-category_add lk-category_edit lk-category_delete">
            ...
            <li>
                <a href="{{ url('/admin/products/1') }}"
                    class="lk-products lk-product_add lk-product_search lk-product_edit lk-product_gallery_add lk-product_inventory"><i
            ...
            <li>
                <a href="{{ url('/admin/sliders') }}" class="lk-sliders_list lk-slider_edit"><i
                        class="fas fa-images"></i>Sliders</a>
            </li>
            @endif
            ...
            <li>
                <a href="{{ url('/admin/coverage') }}" class="lk-coverage_list lk-coverage_edit"><i
                        class="fas fa-shipping-fast"></i>Covertura de envios</a>
            </li>
            @endif
            ...
            @endif
            @if (kvfj(Auth::user()->permissions, 'configuracion'))
            <li>
                <a href="{{ url('/admin/configuracion') }}" class="lk-configuracion"><i class="fas fa-cogs"></i>Configuraciones</a>
            </li>
            @endif
        </ul>
    </div>
