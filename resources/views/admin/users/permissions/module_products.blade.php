    ...
    <div class="panel shadow">
        ...
        <div class="inside">
            ...
            <div class="form-check">
                ...
                <label for="product_gallery_add"> Puede agregar imágenes a galeria</label>
            </div>
            <div class="form-check">
                <input type="checkbox" value="true" name="product_gallery_deleted" @if(kvfj($u->permissions, 'product_gallery_deleted')) checked @endif>
                <label for="product_gallery_deleted"> Puede eliminar imágenes de galeria</label>
            </div>
        </div>
