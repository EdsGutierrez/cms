...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/coverage/' . $coverage->state_id . '/cities') }}"><i class="fas fa-shipping-fast"></i>
            {{ $coverage->getState->name }}</a>
    </li>
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/coverage/city/' . $coverage->id . '/edit') }}"><i class="fas fa-shipping-fast"></i>
            {{ $coverage->name }}</a>
    </li>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="panel shadow">
                    <div class="header">
                        <h2 class="title"><i class="fas fa-info"></i> Informacón general</h2>
                    </div>
                    <div class="inside">
                        @if ($coverage->ctype == '1')
