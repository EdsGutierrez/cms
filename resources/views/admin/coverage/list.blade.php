    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel shadow">
                    <div class="header">
                        <h2 class="title"><i class="fas fa-shipping-fast"></i> Listado de Estados / Departamentos
                        </h2>
                    </div>
                    <div class="inside">
                        <table class="table mtop16">
                            <thead>
                                <tr>
                                    ...
                                    <td><strong>Estado / Departamentos</strong></td>
                            ...
                            <tbody>
                                @foreach ($states as $state)
                                    <tr>
                                        ...
                                        <td>{{ $state->name }}</td>
                                        <td>{{ config('mycms.currency') }}{{ $state->price }}</td>
                                        <td>{{ $state->days }} días</td>
                                        <td>
                                            <div class="opts">
                                                @if (kvfj(Auth::user()->permissions, 'coverage_edit'))
                                                    <a href="{{ url('/admin/coverage/' . $state->id . '/edit') }}"
                                                ...
                                                @if (kvfj(Auth::user()->permissions, 'coverage_delete'))
                                                    <a href="{{ url('/admin/coverage/' . $state->id . '/delete') }}"
                                                        ...
                                                        data-object="{{ $state->id }}" data-toggle="tooltip"
