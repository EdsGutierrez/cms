...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/coverage/' . $coverage->id . '/edit') }}"><i class="fas fa-edit"></i> Editar Estado / Deprtamento</a>
    </li>
@endsection
            ...
            <div class="col-md-3">
                @if (kvfj(Auth::user()->permissions, 'coverage_edit'))
                    <div class="panel shadow">
                        <div class="header">
                            <h2 class="title"><i class="fas fa-edit"></i> Editar cobertura de envio</h2>
                        </div>
