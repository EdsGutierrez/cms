...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/product/' . $product->id . '/edit') }}"><i class="fas fa-boxes"></i>
            {{ $product->name }}</a>
    </li>
    <li class="breadcrumb-item">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel shadow">
                    <div class="header">
                        <h2 class="title"><i class="fas fa-box"></i> Lista de Inventarios </h2>
                    </div>
                            ...
                            <tbody>
                                @foreach ($product->getInventory as $inventory)
                                    <tr>
                                        ...
                                        <td>{{ Config('mycms.currency') }} &nbsp; {{ $inventory->price }}</td>
                                        <td width="160">
                                            <div class="opts">
                                                ...
                                                <a href="#" data-path="admin/product/inventory" data-action="delete"
                                                    data-object="{{ $inventory->id }}" data-toggle="tooltip"
