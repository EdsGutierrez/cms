...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/product/' . $inventory->getProduct->id . '/edit') }}"><i class="fas fa-boxes"></i>
            {{ $inventory->getProduct->name }}</a>
    </li>
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/product/' . $inventory->getProduct->id . '/inventory') }}"><i class="fas fa-box"></i>
            Inventario</a>
    </li>
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/product/inventory/' . $inventory->id . '/edit') }}"><i class="fas fa-box"></i>
            {{ $inventory->name }}</a>
    </li>
@endsection
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group mtop16">
                                    ...
                                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Ingrese nombre de la variante']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
